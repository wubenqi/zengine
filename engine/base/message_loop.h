...
// Patch by wubenqi 2012-09-27
// IO use MessagePumpLibevent2
...
#endif
  base::MessagePumpLibevent2* pump_libevent() {
    return static_cast<base::MessagePumpLibevent2*>(pump_.get());
  }
#endif // defined(PATCH_BY_WUBENQI)
...
class BASE_EXPORT MessageLoopForIO : public MessageLoop {
...
#endif
#else
   typedef base::MessagePumpLibevent2::Watcher Watcher;
   typedef base::MessagePumpLibevent2::FileDescriptorWatcher
       FileDescriptorWatcher;
   typedef base::MessagePumpLibevent2::IOObserver IOObserver;

   enum Mode {
     WATCH_READ = base::MessagePumpLibevent2::WATCH_READ,
     WATCH_WRITE = base::MessagePumpLibevent2::WATCH_WRITE,
     WATCH_READ_WRITE = base::MessagePumpLibevent2::WATCH_READ_WRITE
   };
#endif
...
#else
  // Please see MessagePumpLibevent2 for definition.
  bool WatchFileDescriptor(int fd,
                           bool persistent,
                           Mode mode,
                           FileDescriptorWatcher *controller,
 ...
 private:
  base::MessagePumpLibevent2* pump_io() {
    return static_cast<base::MessagePumpLibevent2*>(pump_.get());
  }
#endif // !defined(PATCH_BY_WUBENQI)
